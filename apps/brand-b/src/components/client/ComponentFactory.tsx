...
import { FactoryProvider } from "@repo/slots";
import type { ReactNode } from "react";

/**
 * Sets the defaults that can be used for client components
 */
//import '@repo/ui/client-register';
